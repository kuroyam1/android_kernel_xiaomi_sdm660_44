...
if [ ! -d "$TOOLCHAIN_DIRECTORY" ]; then
    ...
    wget -q https://github.com/ZyCromerZ/Clang/releases/download/15.0.7-20251111-release/Clang-15.0.7-20251111.tar.gz -O file.tar.gz
